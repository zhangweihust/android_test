...
public class MSC {
	...
	public static native byte[] QTTSAudioGet(char ac[], MSCSessionInfo mscsessioninfo);

	public static native int QTTSGetParam(char ac[], byte abyte0[], MSCSessionInfo mscsessioninfo);
	...
	public static native int QISRGetParam(char ac[], byte abyte0[], MSCSessionInfo mscsessioninfo);

	public static native int QISRAudioWrite(char ac[], byte abyte0[], int i, int j, MSCSessionInfo mscsessioninfo);
	...
	public static native byte[] QMSPUploadData(byte abyte0[], byte abyte1[], int i, byte abyte2[], MSCSessionInfo mscsessioninfo);

	public static native byte[] QMSPDownloadData(byte abyte0[], MSCSessionInfo mscsessioninfo);

	public static native byte[] QMSPSearch(byte abyte0[], byte abyte1[], MSCSessionInfo mscsessioninfo);
